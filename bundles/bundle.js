...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"UI\", function() { return UI; });\n/* harmony import */ var _storage__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./storage */ \"./src/storage.js\");\nfunction _createForOfIteratorHelper(o) { if (typeof Symbol === \"undefined\" || o[Symbol.iterator] == null) { if (Array.isArray(o) || (o = _unsupportedIterableToArray(o))) { var i = 0; var F = function F() {}; return { s: F, n: function n() { if (i >= o.length) return { done: true }; return { done: false, value: o[i++] }; }, e: function e(_e) { throw _e; }, f: F }; } throw new TypeError(\"Invalid attempt to iterate non-iterable instance.\\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.\"); } var it, normalCompletion = true, didErr = false, err; return { s: function s() { it = o[Symbol.iterator](); }, n: function n() { var step = it.next(); normalCompletion = step.done; return step; }, e: function e(_e2) { didErr = true; err = _e2; }, f: function f() { try { if (!normalCompletion && it[\"return\"] != null) it[\"return\"](); } finally { if (didErr) throw err; } } }; }\n\nfunction _unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === \"string\") return _arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === \"Object\" && o.constructor) n = o.constructor.name; if (n === \"Map\" || n === \"Set\") return Array.from(n); if (n === \"Arguments\" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return _arrayLikeToArray(o, minLen); }\n\nfunction _arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) { arr2[i] = arr[i]; } return arr2; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\n\nvar UI = /*#__PURE__*/function () {\n  function UI() {\n    _classCallCheck(this, UI);\n\n    this.profile = document.querySelector(\"#profile\");\n    this.repos = document.querySelector(\"#repos\");\n    this.history = document.querySelector(\"#history\");\n    this.input = document.querySelector(\"#search-input\");\n  }\n\n  _createClass(UI, [{\n    key: \"alert\",\n    value: function alert(type, message) {\n      var div = document.createElement(\"div\");\n      div.className = \"alert alert-\".concat(type);\n      div.setAttribute(\"role\", \"alert\");\n      div.textContent = message;\n      document.querySelector(\"#alert-container\").hidden = false;\n      document.querySelector(\"#alert-container\").appendChild(div);\n      setTimeout(function () {\n        document.querySelector(\"#alert-container\").hidden = true;\n        div.remove();\n      }, 2000);\n    }\n  }, {\n    key: \"clearInput\",\n    value: function clearInput() {\n      this.input.value = '';\n    }\n  }, {\n    key: \"setProfile\",\n    value: function setProfile(user) {\n      var parent = this.profile.parentElement.parentElement;\n      parent.hidden = false;\n      this.profile.innerHTML = \"                \\n        <div class=\\\"row\\\">\\n            <div class=\\\"col-md-4\\\">\\n                <a href=\\\"\".concat(user[\"html_url\"], \"\\\" target=\\\"_blank\\\">\\n                    <img class=\\\"img-fluid mb-2\\\" src=\").concat(user[\"avatar_url\"], \">\\n                </a>\\n                <hr color=\\\"gray\\\">\\n                <div class=\\\"full-name\\\">\\n                    <i><span>\\u0130sim :</span></i>\\n                    <br>\\n                    <strong>\").concat(user[\"name\"], \"</strong>\\n                </div>\\n                <hr color=\\\"gray\\\">\\n                <div class=\\\"bio\\\">\\n                    <i><span>Bio:</span></i>\\n                    <br>\\n                    \").concat(user[\"bio\"], \"\\n                </div>\\n            </div>\\n            <div class=\\\"col-md-8\\\">\\n                <div class=\\\"container\\\" style=\\\"text-align: center;\\\">\\n                    <div class=\\\"btn btn-light\\\" role=\\\"button\\\">\\n                        Takip\\xE7i : <span class=\\\"badge badge-dark\\\">\").concat(user[\"followers\"], \"</span>\\n                    </div>\\n                    <div class=\\\"btn btn-light\\\" role=\\\"button\\\">\\n                        Takip Edilen : <span class=\\\"badge badge-dark\\\">\").concat(user[\"following\"], \"</span>\\n                    </div>\\n                    <div class=\\\"btn btn-light\\\">\\n                        Repolar : <span class=\\\"badge badge-dark\\\">\").concat(user[\"public_repos\"], \"</span>\\n                    </div>\\n                </div>\\n                <hr color=\\\"gray\\\" width=\\\"76%\\\" align=\\\"center\\\">\\n                <div class=\\\"list-group\\\" style=\\\"max-width: 76%; margin-left: auto; margin-right: auto;\\\">\\n                    <li class=\\\"list-group-item borderzero\\\">\\n                        <img src=\\\"resimler/company.png\\\" width=\\\"30px\\\"> <span style=\\\"color: black;\\\">\").concat(user[\"company\"], \"</span>\\n                    </li>\\n                    <li class=\\\"list-group-item borderzero\\\">\\n                        <img src=\\\"resimler/location.png\\\" width=\\\"30px\\\"> <span style=\\\"color: black;\\\">\").concat(user[\"location\"], \"</span>\\n                    </li>\\n                    <li class=\\\"list-group-item borderzero\\\">\\n                        <img src=\\\"resimler/mail.png\\\" width=\\\"30px\\\"> <span style=\\\"color: black;\\\">\").concat(user[\"email\"], \"</span>\\n                    </li>\\n                    <li class=\\\"list-group-item borderzero\\\">\\n                        <img src=\\\"resimler/octicon.png\\\" width=\\\"30px\\\"> <span style=\\\"color: black;\\\"><a href=\").concat(user[\"blog\"], \" target=\\\"_blank\\\" style=\\\"color: black;\\\">Ki\\u015Fisel Site</a></span>\\n                    </li>\\n                </div>\\n            </div>\\n        </div>\\n        <hr color=\\\"gray\\\">\\n        <div class=\\\"card-footer\\\">\\n            <p>Last Update : <span>\").concat(user[\"updated_at\"], \"</span></p>\\n        </div>\\n    \");\n    }\n  }, {\n    key: \"setRepos\",\n    value: function setRepos(user) {\n      this.repos.innerHTML = '';\n\n      var _iterator = _createForOfIteratorHelper(user),\n          _step;\n\n      try {\n        for (_iterator.s(); !(_step = _iterator.n()).done;) {\n          var repo = _step.value;\n          this.repos.innerHTML += \"   <div id=\\\"row-container\\\">\\n                    <div class=\\\"row\\\">\\n                        <div class=\\\"col-md-9\\\">\\n                            <div class=\\\"alert alert-light\\\">\\n                                <a href=\\\"\".concat(repo[\"html_url\"], \"\\\" target=\\\"_blank\\\" id=\\\"repoName\\\" style=\\\"color: black\\\";>\").concat(repo[\"name\"], \"</a>\\n                            </div>\\n                        </div>\\n                        <div class=\\\"col-md-6\\\">\\n                            <button class=\\\"btn btn-light\\\">\\n                                Starlar <span class=\\\"badge badge-dark\\\" id=\\\"repoStar\\\">\").concat(repo[\"stargazers_count\"], \"</span>\\n                            </button>\\n                            <button class=\\\"btn btn-secondary\\\">\\n                                Forklar <span class=\\\"badge badge-dark\\\">\").concat(repo[\"forks_count\"], \"</span>\\n                            </button>\\n                        </div>\\n                    </div>\\n                    <hr color=\\\"gray\\\">\\n                </div>\\n            \");\n        }\n      } catch (err) {\n        _iterator.e(err);\n      } finally {\n        _iterator.f();\n      }\n    }\n  }, {\n    key: \"filterRepos\",\n    value: function filterRepos(value) {\n      // let formControl = document.querySelector(\"#filter\");\n      // let filterValue = formControl.value.toLowerCase();\n      // let tbody = document.querySelector(\"#films\").childNodes;\n      // tbody.forEach(movie => {\n      //     let titles = movie.children[1].textContent.toLowerCase();\n      //     if(titles.indexOf(filterValue) === -1){\n      //         movie.hidden = true;\n      //     }else{\n      //         movie.hidden = false;\n      //     }\n      // });\n      value = value.toLowerCase();\n      var repos = document.querySelectorAll(\"#row-container\"); // console.log(repos);\n\n      repos.forEach(function (repo) {\n        var title = repo.children[0].children[0].textContent.toLowerCase().trim();\n\n        if (title.indexOf(value) === -1) {\n          repo.hidden = true;\n        } else {\n          repo.hidden = false;\n        }\n      });\n    }\n  }, {\n    key: \"setHistory\",\n    value: function setHistory(username) {\n      var users = _storage__WEBPACK_IMPORTED_MODULE_0__[\"Storage\"].getSearched();\n\n      if (users.indexOf(username) == -1) {\n        var searchList = document.querySelector(\"#history\");\n        searchList.innerHTML += \"\\n                <li class=\\\"list-group-item bg-secondary text-white d-flex justify-content-between\\\">\\n                    <h6>\".concat(username, \"</h6>\\n                    <a class=\\\"fa fa-remove\\\"></a>\\n                </li>\\n            \");\n      }\n    }\n  }, {\n    key: \"deleteProfile\",\n    value: function deleteProfile() {\n      var parent = this.profile.parentElement.parentElement;\n      parent.hidden = true;\n      this.profile.innerHTML = '';\n      var repos = this.repos.parentElement;\n\n      if (repos) {\n        repos.innerHTML = '';\n      }\n    } // inf() {\n    //     console.log(this.profile,this.repos,this.history,this.input);\n    // }\n\n  }]);\n\n  return UI;\n}(); // let i = new UI();\n// i.inf();\n\n//# sourceURL=webpack:///./src/ui.js?");
